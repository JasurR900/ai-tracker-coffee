...
description — аппетитное описание блюда на фото в 2–3 предложениях, например:
"На фото изображено аппетитное блюдо: порция рассыпчатого белого риса и сочные кусочки курицы в густом глазурованном соусе."`;
